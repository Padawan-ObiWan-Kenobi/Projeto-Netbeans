...
public class PesquisarClientes extends javax.swing.JDialog {    
     ...
     */
    public PesquisarClientes(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonSelecionar1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButtonSelecionar1.setForeground(new java.awt.Color(102, 102, 255));
        jButtonSelecionar1.setText("Cancelar");
...
// Preenchendo a tabela
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        //preencherTabelaCliente("select id_cliente, nome_cliente from clientes where nome_cliente like'%"+jTextFieldPesquisaCliente.getText()+"%'");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisarClientes dialog = new PesquisarClientes(new javax.swing.JDialog(), true);
